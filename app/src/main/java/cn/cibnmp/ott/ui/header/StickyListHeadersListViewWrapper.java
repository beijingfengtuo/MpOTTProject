...
public class StickyListHeadersListViewWrapper extends FrameLayout implements Pullable {
	...
	public interface canPullListener {
		boolean onCanPull(int data);
	}

	private canPullListener mCanPullListener = null;

	public void setOnCanPullListener(canPullListener mCanPullListener) {
		this.mCanPullListener = mCanPullListener;
	}

	@Override
	public boolean canPullDown() {
		if (mCanPullListener != null) {
			if (mCanPullListener.onCanPull(0)) {
				return true;
			}
		}
		return false;
	...
	public boolean canPullUp() {
		if (mCanPullListener != null) {
			if (mCanPullListener.onCanPull(1)) {
				return true;
			}
		}
		return false;
