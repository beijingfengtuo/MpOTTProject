...
public class PlayerLogBeanB {

	private String logtype = "play";
	private String playid;
	private String playevent = "3";  //start-开始播放  flash-播放中  end-播放结束
	private String playstatus = "5";  //ready-准备中 playing-播放中 pause-暂停中 buffer-缓存中 end-播放结束
	...
	public PlayerLogBeanB(String playId) {
		this.playid = playId;
	}
