...
import cn.cibnmp.ott.library.R;
...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private PullToRefreshLayout context;

    private final int msgUpdateZD = 6666;
    /**
     * 执行自动回滚的handler
     */
    Handler updateHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == msgUpdateZD) {
                mListener.onLoadMore(context);
                updateHandler.removeMessages(msgUpdateZD);
            } else {
    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateTextView.setTextColor(getResources().getColor(R.color.pullorload_success));
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateTextView.setTextColor(getResources().getColor(R.color.pullorload_success));
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            case INIT:
                ...
                refreshStateTextView.setTextColor(getResources().getColor(R.color.pullorload_default));
                pullView.setBackgroundResource(R.drawable.pull_icon_big);
                pullView.setVisibility(View.VISIBLE);
                // 上拉布局初始状态
                loadStateImageView.setVisibility(View.GONE);
                loadStateTextView.setTextColor(getResources().getColor(R.color.pullorload_default));
                loadStateTextView.setText(R.string.pullup_to_load);
                // pullUpView.clearAnimation();
                pullUpView.setBackgroundResource(R.drawable.pullup_icon_big);
                pullUpView.setVisibility(View.VISIBLE);
                break;
            case RELEASE_TO_REFRESH:
                // 释放刷新状态
                refreshStateTextView.setText(R.string.release_to_refresh);
                pullView.setBackgroundResource(R.drawable.pullup_icon_big);
                break;
            case REFRESHING:
                // 正在刷新状态
                pullView.setBackgroundResource(R.drawable.pull_icon_big);
            ...
            case RELEASE_TO_LOAD:
                ...
                pullUpView.setBackgroundResource(R.drawable.pull_icon_big);
                break;
            case LOADING:
                // 正在加载状态
                // pullUpView.clearAnimation();
    ...
    public void autoLoad() {
        ...
        if (mListener != null) {
            context = this;
            updateHandler.sendEmptyMessageDelayed(msgUpdateZD, 1000);
        }
    }
